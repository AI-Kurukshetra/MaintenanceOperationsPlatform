...
import { createMaintenancePlan } from "@/app/(dashboard)/maintenance/actions";
...
import {
  ...
  type MaintenancePlanCreateInput,
...
export default function NewMaintenancePlanPage() {
  ...
  type MaintenanceFormInput = z.input<typeof maintenancePlanCreateSchema>;

  const form = useForm<MaintenanceFormInput>({
    resolver: zodResolver(maintenancePlanCreateSchema),
    defaultValues: {
      name: "",
      description: "",
  ...
  const { handleSubmit, register, control, setValue, watch, formState: { errors } } = form;
  ...
  const onSubmit = async (input: MaintenanceFormInput) => {
    if (!canCreate) {
      toast.error("You do not have permission to create maintenance plans.");
      return;
    }

    setIsSubmitting(true);
    try {
      const parsed = maintenancePlanCreateSchema.parse(input) as MaintenancePlanCreateInput;
      await createMaintenancePlan(parsed);
      toast.success("Maintenance plan created successfully.");
      router.push("/maintenance");
    } catch (error) {
      toast.error(error instanceof Error ? error.message : "Failed to create maintenance plan.");
    } finally {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <PageHeader title="Create PM Schedule" description="Set up preventive maintenance automation." />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Select
                value={watch("type")}
                onValueChange={(value) => setValue("type", value as MaintenancePlanCreateInput["type"])}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setValue("frequency_unit", value as MaintenancePlanCreateInput["frequency_unit"])
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setValue(
                          "condition_operator",
                          value as MaintenancePlanCreateInput["condition_operator"]
                        )
                      }
                    >
                      <SelectTrigger>
          ...
          <CardContent className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setValue("wo_priority", value as MaintenancePlanCreateInput["wo_priority"])
                }
              >
                <SelectTrigger>
                  <SelectValue />
